...
Build status
------------
- Develop: [![https://github.com/sdl/dxa-model-service/workflows/Java%20CI%20with%20Maven/badge.svg?branch=develop](boo)](https://github.com/sdl/dxa-model-service/actions?query=workflow%3A%22Java+CI+with+Maven%22)
