...
public class MultipleEntryLinkProcessor implements LinkProcessor {
    private Map<String, String> model;

    private String id;
    private String key;

    public MultipleEntryLinkProcessor(Map<String, String> map, String key) {
        this.model = map;
        this.key = key;
    ...
    private String _createId() {
        int itemId = TcmUtils.getItemId(this.key);
